class MysteryBoxRewardDefinition {
  ...
  bool get isEmpty => !hasCoins && !hasXp && !hasUtilityRewards;

  MysteryBoxRewardDefinition copyWith({
    String? id,
    int? weight,
    int? coins,
    int? xp,
    ...
    return MysteryBoxRewardDefinition(
      id: id ?? this.id,
  ...
  factory MysteryBoxRewardDefinition.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) {
    ...
    return other is MysteryBoxRewardDefinition &&
        other.id == id &&
        other.weight == weight &&
        other.coins == coins &&
        other.xp == xp &&
