...
class ShopCatalog {
  ...
  static const List<ShopItem> _utilityItems = <ShopItem>[
    ...
    ShopItem(
      ...
      description: 'Recover a lost streak once.',
      category: ShopItemCategory.utility,
      type: ShopItemType.streakRecover,
      rarity: ShopItemRarity.rare,
      priceCoins: 250,
      assetRef: 'assets/shop/utilities/streak_recover.png',
      metadata: <String, dynamic>{'charges': 1},
    ),
    ShopItem(
      id: 'utility_streak_shield_1',
      title: 'Streak Shield',
      description: 'Protect a streak from one missed day.',
      category: ShopItemCategory.utility,
      type: ShopItemType.streakShield,
      rarity: ShopItemRarity.rare,
      priceCoins: 300,
      assetRef: 'assets/shop/utilities/streak_shield.png',
      metadata: <String, dynamic>{'charges': 1},
    ),
    ShopItem(
      id: 'utility_mystery_box_basic',
      title: 'Mystery Box',
      description: 'A basic mystery box with a surprise inside.',
      category: ShopItemCategory.utility,
