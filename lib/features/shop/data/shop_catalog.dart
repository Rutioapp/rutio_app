...
class ShopCatalog {
  ...
  static final List<ShopItem> _cosmeticItems = <ShopItem>[
    ...
    _cosmetic(
      ...
      description: 'Habit card gris piedra con textura discreta.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.rare,
      priceCoins: 250,
      familyId: 'calm_sand',
    ...
    _cosmetic(
      ...
      description: 'Habit card terracota suave con tacto visual calmado.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.rare,
      priceCoins: 250,
      familyId: 'soft_linen',
    ...
    _cosmetic(
      ...
      description: 'Habit card rosa arcilla con calidez suave.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.rare,
      priceCoins: 250,
      familyId: 'paper_dawn',
    ...
    _cosmetic(
      ...
      title: 'Violet Flame Habit Card',
      description:
          'Habit card lavanda con llama decorativa lateral y contraste suave.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.rare,
      priceCoins: 250,
    ...
    _cosmetic(
      ...
      description: 'Habit card lila empolvado con calma suave.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.epic,
      priceCoins: 550,
    ...
    _cosmetic(
      ...
      description: 'Habit card azul niebla con presencia serena.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.epic,
      priceCoins: 550,
    ...
    _cosmetic(
      ...
      description: 'Habit card verde savia con profundidad refinada.',
      type: ShopItemType.habitCard,
      rarity: ShopItemRarity.legendary,
      priceCoins: 1200,
      familyId: 'golden_dawn',
