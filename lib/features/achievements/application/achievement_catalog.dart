...
class AchievementCatalog {
  ...
  static const List<_SpecialAchievementDefinition> _specialAchievements = [
    ...
    _SpecialAchievementDefinition(
      id: 'special:flash',
      title: 'Flash',
      description: 'Completa 8 habitos en un solo dia.',
    ...
    _SpecialAchievementDefinition(
      ...
      description: 'Completa habitos durante 30 dias de fin de semana.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'El arquitecto',
      description: 'Realiza 750 acciones totales.',
    ...
    _SpecialAchievementDefinition(
      ...
      description:
          'Consigue 21 dias perfectos completando todo lo programado.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'Imparable',
      description:
          'Encadena una racha global de 30 dias con al menos un habito completado.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'Coleccionista',
      description: 'Desbloquea 40 logros distintos.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'Leyenda viva',
      description: 'Completa 1500 veces en historico tus habitos.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'Francotirados',
      description:
          'Clava exactamente el objetivo de un habito numerico 100 veces.',
    ...
    _SpecialAchievementDefinition(
      ...
      title: 'Reloj suizo',
      description:
          'Completa 30 veces un habito dentro de los 10 minutos de su recordatorio.',
    ...
    _SpecialAchievementDefinition(
      id: 'special:veterano',
      title: 'Veterano',
      description: 'Completa tus habitos en 240 dias distintos.',
