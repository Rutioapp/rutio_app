...
| --- | --- | --- | --- | --- | --- |
| `special:madrugador` / Madrugador | Completar hábitos temprano | 10 completados antes de las 09:00 | 50 completados antes de las 09:00 | Consistency | Se refuerza como hábito horario sostenido y no como un desbloqueo de pocos días. |
| `special:buho_nocturno` / Búho nocturno | Completar hábitos tarde | 10 completados después de las 22:00 | 50 completados después de las 22:00 | Consistency | Misma lógica que Madrugador para exigir identidad de uso real y repetida. |
...
| `special:turista` / Turista | Explorar variedad real de familias | 5 familias con al menos un hábito completado | 6 familias distintas dentro de una ventana de 7 días | Consistency | Pasa de un desbloqueo acumulativo muy fácil a una exploración semanal real. |
| `special:polimota` / Polimota | Cubrir todas las familias | Tener al menos un hábito activo en cada familia | 7 familias distintas completadas dentro de una ventana de 21 días | Advanced | Ahora es una versión claramente más extrema que `turista` basada en uso real, no solo configuración. |
| `special:hay_alguien_ahi` / ¿Hay alguien ahí? | Actividad social | 7 días sociales distintos | 15 hábitos sociales completados en total | Entrada / consistencia | Se cambia el concepto para separarlo de un simple contador de días sociales. |
| `special:ave_fenix` / Ave fénix | Volver tras abandonar el ritmo | 1 recuperación de racha | Volver completando un hábito tras 2 días o más sin actividad | Entrada / consistencia | Se alinea mejor con el fantasy de “regresar” que con la métrica anterior de recuperación de rachas. |
...
| `special:el_centurion` / El centurión | Constancia mayoritaria sostenida | 100 completados | 150 días con más del 50% de lo programado completado | Long-term | Deja de ser puro volumen y pasa a representar adherencia diaria consistente. |
